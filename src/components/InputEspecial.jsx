                ...
                {<div className={`   overflow-auto   transition-all rounded-[5px]  
                ...
                }>
                    {
                        data.reduce((acc, i, index) => {
                            ...
                            return i.toUpperCase().includes(inputRef.current && inputRef.current.value ? inputRef.current.value.toUpperCase() : '') && <div className="transition-all px-5 relative z-0 w-full  group border-t border-[#dddddd] px-2 py-2  text-[12px]" onClick={() => select(i)}>
                                {i}
                            </div>
                        })
                    }
